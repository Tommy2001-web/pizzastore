...
public class FilmController {
	...
	public String searchFilm(Model model) {
		model.addAttribute("search_film_attr", new FilmDTO());
	...
	@PostMapping("/list")
	public String listFilms(@ModelAttribute("search_film_attr") FilmDTO filmExample, ModelMap model) {
		List<Film> films = filmService.findByExample(filmExample.buildFilmModel());
		model.addAttribute("film_list_attribute", FilmDTO.createFilmDTOListFromModelList(films, true));
		return "film/list";
	}
	...
	public String editRegista(@PathVariable(required = true) Long idFilm, Model model) {
