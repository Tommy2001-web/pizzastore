    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form:form method="post" modelAttribute="edit_ordine_attr"
                        ...
                        <spring:bind path="clienteId">
                            <select class="form-select ${status.error ? 'is-invalid' : ''}" id="clienteId" name="clienteId">
                                ...
                                <c:forEach items="${cliente_list}" var="c">
                                    <c:if test="${c.attivo}">
                                        <option value="${c.id}" ${c.id == edit_ordine_attr.clienteId ? 'selected' : ''}>
                                                ${c.nome}
                                        </option>
                                    </c:if>
                                </c:forEach>
                            ...
                            <c:forEach items="${pizza_list}" var="p">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input pizzaCheck" type="checkbox"
                                        ...
                                        ${edit_ordine_attr.pizzaIds.contains(p.id) ? 'checked' : ''}
                                        ${!p.attivo ? 'disabled' : ''}>
                    ...
                    <div class="col-md-6">
                        ...
                        <spring:bind path="costoTotale">
                            <input type="text" id="costoTotale" name="costoTotale" readonly
                                   class="form-control" value="${edit_ordine_attr.costoTotale != null ? edit_ordine_attr.costoTotale : 0}">
                        </spring:bind>
...
<script>
    ...
    window.addEventListener("load", calcolaPrezzo);
</script>
</body>
</html>